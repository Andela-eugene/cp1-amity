...
class AmityPersonDB:
	...
	def __init__(self, **kwargs):
		...
		self._db.sql_do(' CREATE TABLE IF NOT EXISTS {} (person_id INTEGER PRIMARY KEY, firstname TEXT NOT NULL, lastname TEXT NOT NULL, role TEXT NOT NULL, boarding INTEGER NOT NULL, office_allocated INTEGER, accomodation_allocated INTEGER, FOREIGN KEY (office_allocated) REFERENCES room(room_id), FOREIGN KEY (accomodation_allocated) REFERENCES room(room_id))'.format(self.table))
